...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/static/css/home.css"/>"/>
    ...
    <script type="text/javascript"
            src="<c:url value="/static/jquery/jquery-1.12.4.min.js"/>"></script>
    <script type="text/javascript"
            src="<c:url value="/static/bootstrap-3.3.7-dist/js/bootstrap.js"/>"></script>
    <script type="text/javascript"
